...
func filenamesFromCommandLine() (inFilename, outFilename string, err error) {
	...
	return inFilename, outFilename, nil // last one could err
}
...
func americanise(inFile io.Reader, outFile io.Writer) (err error) {
	...
	var replacer func(string) string // declared b/c err is declared as named output var
	...
	for !eof {
		...
		if err == io.EOF {
			err = nil  // io.EOF is not really an error
